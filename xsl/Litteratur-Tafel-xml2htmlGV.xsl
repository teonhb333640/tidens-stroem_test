        ...
        <div class="row">
            ...
            <xsl:element name="img">
                ...
                <xsl:attribute name="src">
                    <xsl:value-of select="concat('pics/',tei:graphic/@url)"></xsl:value-of>
                </xsl:attribute>
                <xsl:attribute name="usemap">
                    <xsl:value-of select="concat('#',substring-before(@url,'.png'))"></xsl:value-of>
                </xsl:attribute>
            </xsl:element>
        </div>
                <xsl:call-template name="make_map">
                    <xsl:with-param name="surface-id">
                         <xsl:value-of select="substring-before(@url,'.png')"/>
                    </xsl:with-param>
                </xsl:call-template>
